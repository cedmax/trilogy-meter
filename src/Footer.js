...
export default ({ updatedAt }) => (
  <footer className={cssStyles.footer}>
    ...
    <p>
      ...
      Ratings from <a rel="noopener noreferrer" href="https://www.imdb.com"><img width="50" src="/imdb.png" alt="IMDb" /></a> and <a rel="noopener noreferrer" href="https://www.themoviedb.org"><img width="60" src="/tmdb.png" alt="The Movie Database" /></a>, last fetched
